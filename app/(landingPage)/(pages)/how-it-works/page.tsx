...
const HowItWorksPage = () => (
  <section className="flex justify-center items-center w-full">
    <main className="flex flex-col items-center w-full">
      ...
      <section className="flex flex-col w-full max-w-screen-2xl items-center gap-y-10 px-4 md:px-10">
      ...
      <section className="flex flex-col items-center w-full bg-[url(/LandingPage/communityExploration.png)] bg-left-top bg-no-repeat py-10 md:py-20 mb-10 px-4 md:px-10 z-10">
        <main className="flex flex-col items-center w-full max-w-screen-2xl px-4 py-6 md:px-10 gap-y-10">
          <h2 className="text-[24px] md:text-[30px] text-[#232426] font-medium text-center w-full md:w-2/5">
            Learn about <span className="text-[#003CB1]">DAOit</span> Verification and Community Exploration
          </h2>

          <article className="flex flex-col gap-y-8 w-full">
            <div className="flex flex-col md:flex-row justify-between items-center w-full gap-y-5 md:gap-x-36">
              <h3 className="text-2xl md:text-4xl w-full md:w-2/5 text-center md:text-left">✅ Verify Your Identity</h3>
              <p className="w-full md:w-3/5 text-center md:text-left">DAOit is built on trust, transparency, and collaboration. To fully access the platform&apos;s core features , such as governance participation, funding opportunities, and advanced community tools , you&apos;ll need to complete a one-time identity verification process. This ensures that every participant is genuine, reducing spam, bots, and bad actors. It also helps build a reputation layer that supports long-term growth, accountability, and peer trust across the ecosystem.</p>
            </div>

            <div className="flex flex-col md:flex-row justify-between items-center gap-y-5 md:gap-x-36 w-full">
              <h3 className="text-2xl md:text-4xl w-full md:w-2/5 leading-relaxed text-center md:text-left">🌐 Explore, Join & Build Communities</h3>
              <div className="w-full md:w-3/5 text-center md:text-left">
                <p>DAOit is more than a platform, it&apos;s a network of decentralized learning communities.</p>
                <ul className="list-disc pl-5 my-4 text-left">
