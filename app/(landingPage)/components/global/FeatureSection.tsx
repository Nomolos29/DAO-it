      ...
      <div className="flex flex-col items-center md:gap-5 max-w-screen-2xl w-full">
        ...
        <section className="text-center md:text-left w-full py-[100px] relative px-[50px] bg-[#FFFCE7] overflow-hidden">
          <div className="flex justify-between w-full z-10">
            ...
            <img src="/LandingPage/blockChain.png" alt="block chain image representation" width={0} height={0} className="bg-contain -mt-12 w-[50%]" />
          </div>

          <div className="flex justify-between w-full z-10">
            <img src="/LandingPage/recircle.png" alt="block chain image representation" width={0} height={0} className="bg-contain -mt-12 -mb-12 w-[50%]" />
          ...
          <img src="/LandingPage/bgImage.png" alt="block chain image representation" width={0} height={0} className="flex absolute top-0 z-0 -left-10 w-[50%]" />
