      ...
      <main className="flex justify-between max-w-screen-2xl w-full py-10 px-10">
        <section className="flex justify-center flex-col w-1/2">
          ...
          <div className="mt-6 flex gap-4">
            <Link href="/app">
              <button type="button" className="bg-gradient-to-r from-[#F8B51C] to-[#FEE539] hover:bg-yellow-600 text-black text-md py-3 rounded shadow-md shadow-[#F8B51C33] w-[200px] h-[54px]">
                Launch App
              </button>
            </Link>

            <button type="button" className="flex rounded-[8px] justify-center items-center w-[200px] h-[54px] bg-gradient-to-br from-[#3E4141] to-[#F8B91E] p-[1px]">
