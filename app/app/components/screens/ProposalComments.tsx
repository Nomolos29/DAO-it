...
import { ProposalCommentsProps } from '../../types/types'
            ...
            <section className='flex justify-between items-center'>
              <div className='flex flex-col gap-y-3'>
                ...
                <div className='flex items-center gap-x-2'>
                  ...
                  <div>
                    <p className='flex items-center gap-x-2'>{comment.userId}
                ...
                <section className='flex flex-col gap-y-2'>
                  ...
                  <p className='text-[#2E3035] text-sm line-clamp-3'>{comment.commentText}</p>
                </section>
              </div>
            </section>
          </div>
