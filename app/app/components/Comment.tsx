...
// const Comment:React.FC<CommentProps> = ({postID, username, comment, profilePic, postBy, postComments, commentCreationDate, commentDislikes, commentLikes, postStatus, postDetailsPage, postImage, postVotes}) => {
