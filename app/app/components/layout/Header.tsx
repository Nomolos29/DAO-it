      ...
      <main className="h-full flex justify-end w-full items-center gap-10">
        <div className="flex  justify-end">
          <span className="flex group items-center overflow-hidden translate-x-8 hover:translate-x-0 transition-all duration-500 cursor-pointer">
            ...
            <p className="text-[12px] text-black py-[1px] pr-2 pl-4 rounded-full border border-yellow-500 bg-yellow-200 -translate-x-[54px] group-hover:-translate-x-3 transition-all duration-500 font-semibold">
              100.00 DAT
            </p>
          </span>
        </div>
