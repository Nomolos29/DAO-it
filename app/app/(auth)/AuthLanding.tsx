    ...
    <div className='w-full h-screen flex justify-center items-center'>
      <main className='container w-full flex justify-between items-center gap-x-[150px] px-8'>
        <aside className='w-1/2 flex flex-col gap-y-4'>
          ...
          <p className='text-center text-[16px] text-[#494445] font-medium px-5'>Take power to shape your school´s future. Join the teacher-student-led movement for future-ready learning</p>
        </aside>

        <aside className='w-1/2 flex flex-col gap-y-8 px-10'>
          <h3 className='text-[36px]'>Join Us Today</h3>
